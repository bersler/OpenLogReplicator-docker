...
# Run:
#       $ docker build -t bersler/openlogreplicator:centos-8 -f Dockerfile --build-arg IMAGE=centos --build-arg VERSION=8 --build-arg GIDOLR=1001 --build-arg UIDOLR=1001 --build-arg GIDORA=54322 --build-arg WITHKAFKA=1 --build-arg WITHPROTOBUF=1 --build-arg WITHROCKETMQ=1 --build-arg WITHORACLE=1 --build-arg BUILDDEV=1 .
#       $ docker build -t bersler/openlogreplicator:debian-11.0 -f Dockerfile --build-arg IMAGE=debian --build-arg VERSION=11.0 --build-arg GIDOLR=1001 --build-arg UIDOLR=1001 --build-arg GIDORA=54322 --build-arg WITHKAFKA=1 --build-arg WITHPROTOBUF=1 --build-arg WITHROCKETMQ=1 --build-arg WITHORACLE=1 --build-arg BUILDDEV=1 .
#       $ docker build -t bersler/openlogreplicator:ubuntu-20.04 -f Dockerfile --build-arg IMAGE=ubuntu --build-arg VERSION=20.04 --build-arg GIDOLR=1001 --build-arg UIDOLR=1001 --build-arg GIDORA=54322 --build-arg WITHKAFKA=1 --build-arg WITHPROTOBUF=1 --build-arg WITHROCKETMQ=1 --build-arg WITHORACLE=1 --build-arg BUILDDEV=1 .
#
...
ARG OPENLOGREPLICATOR_VERSION=0.9.37-beta
ARG GIDOLR=1001
ARG UIDOLR=1001
ARG GIDORA=54322
ARG BUILDDEV
